...
export class DocumentFragment<ChildType: VirtualNode>
    ...
    /**
     * Creates a deep copy of the document fragment.
     */
    clone(): DocumentFragment<ChildType> {
        // Recursively clone all children
        const clonedChildren = this.children.map(child => child.clone());

        // Return a new DocumentFragment instance with the cloned children
        return new DocumentFragment(clonedChildren);
    }
}
