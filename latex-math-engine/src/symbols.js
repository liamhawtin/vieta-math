...
defineSymbol(math, main, open, "\u2983", "\\lBrace", true);
defineSymbol(math, main, close, "\u2984", "\\rBrace", true);
...
defineSymbol(math, main, open, "\u007C", "|");
defineSymbol(math, main, open, "\u007C", "\\vert");
...
defineSymbol(math, main, open, "\u2191", "\\uparrow", true);
defineSymbol(math, main, open, "\u21d1", "\\Uparrow", true);
defineSymbol(math, main, open, "\u2193", "\\downarrow", true);
defineSymbol(math, main, open, "\u21d3", "\\Downarrow", true);
defineSymbol(math, main, open, "\u2195", "\\updownarrow", true);
defineSymbol(math, main, open, "\u21d5", "\\Updownarrow", true);
...
defineSymbol(text, main, textord, "\u22ee", "\\vdots");
