...
export default class Lexer implements LexerInterface {
    ...
    lex(): Token {
        ...
        // Adjust lastIndex to exclude trailing whitespace
        if (this.settings.keepWhiteSpace && match[1] === undefined) { // If the match is not pure whitespace
            const trailingSpaceLength = match[0].length - text.length;
            this.tokenRegex.lastIndex -= trailingSpaceLength;
        }
